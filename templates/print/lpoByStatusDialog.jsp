...
<html>
    <head>
        ...
        <title>Purchase Order By Status - Print</title>
    </head>
<!-- Frameset for Nav, ButtonNav, and Content frames -->
    <frameset cols="100%" frameborder="yes" border="1">
        ...
        <frameset rows="32,*" frameborder="yes" border="0">
            ...
            <!-- Content Frame -->
            <frame src="lpoByStatusContent.jsp?operationType=findByStatus&output=HTML&status=<%=request.getParameter("status")%>&beginDate=<%=request.getParameter("beginDate")%>&endDate=<%=request.getParameter("endDate")%>"
