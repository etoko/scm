    ...
    <head>
        ...
        <script>
                ...
                function()
                {
                    ...
                    dojo.xhrGet(
                    {
                        url: "../../servlets/purchaseOrderReport?operationType=findByStatus&output=HTML&status=<%=request.getParameter("status")%>&beginDate=<%=request.getParameter("beginDate")%>&endDate=<%=request.getParameter("endDate")%>",
